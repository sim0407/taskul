...
from .commands.create_milestone import create_milestone
from .commands.create_task import create_task
from .commands.get_board import get_board
from .commands.get_milestones import get_milestones_cmd
...
from .commands.update_milestone import update_milestone
...
cli.add_command(create_milestone)
cli.add_command(create_task)
cli.add_command(get_board)
cli.add_command(get_milestones_cmd)
...
cli.add_command(update_milestone)
